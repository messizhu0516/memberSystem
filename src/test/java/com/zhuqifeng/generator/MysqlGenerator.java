package com.zhuqifeng.generator;
...
/**
 * ClassName: MysqlGenerator <br/>
 * Function: TODO <br/>
 * Reason: TODO <br/>
 * date: 2018年5月31日 下午2:36:10 <br/>
 * 
 * @author QiFeng.Zhu
 * @version 1.0
 * @since JDK 1.8
...
public class MysqlGenerator {
	...
	public static void main(String[] args) {
		...
		strategy.setInclude(new String[] { "member_info","member_card","shop" }); // 需要生成的表
		// strategy.setExclude(new String[]{"test"}); // 排除生成的表
		// 自定义实体父类
		strategy.setSuperEntityClass("com.zhuqifeng.model.base.BaseEntity");
		// 自定义实体，公共字段
		...
		// 自定义 controller 父类
		strategy.setSuperControllerClass("com.zhuqifeng.controller.common.BaseController");
		...
		pc.setParent("com.zhuqifeng"); // 自定义包路径
		pc.setController("controller.biz"); // 这里是控制器包名，默认 web
		...
		focList.add(new FileOutConfig("/generate/templates/add.jsp.vm") {
			@Override
			public String outputFile(TableInfo tableInfo) {
				return getGeneratorViewPath(viewOutputDir, tableInfo, "Add.jsp");
			}
		});
		focList.add(new FileOutConfig("/generate/templates/edit.jsp.vm") {
			@Override
			public String outputFile(TableInfo tableInfo) {
				return getGeneratorViewPath(viewOutputDir, tableInfo, "Edit.jsp");
			}
		});
		focList.add(new FileOutConfig("/generate/templates/list.jsp.vm") {
			@Override
			public String outputFile(TableInfo tableInfo) {
