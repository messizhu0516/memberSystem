...
import com.zhuqifeng.commons.result.AjaxResult;
import com.zhuqifeng.commons.utils.base.WebUtils;
import com.zhuqifeng.commons.utils.beanclone.BeanUtils;

/**
 * 异常处理，对ajax类型的异常返回ajax错误，避免页面问题 Created by L.cm Date: 2016-24-03 16:18
 */
@Component
...
public class ExceptionResolver implements HandlerExceptionResolver {
	...
	public ModelAndView resolveException(HttpServletRequest request, HttpServletResponse response, Object handler, Exception e) {
		...
		if (WebUtils.isAjax(handlerMethod)) {
			...
			return new ModelAndView(view, BeanUtils.toMap(new AjaxResult(false, e.getMessage())));
		}
