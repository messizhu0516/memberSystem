...
import com.zhuqifeng.commons.utils.json.JacksonUtil;
import com.zhuqifeng.commons.weixin.util.RetryUtils.ResultCheck;
...
public class SnsAccessToken implements ResultCheck, Serializable {
	...
	public SnsAccessToken(String jsonStr) {
		this.json = jsonStr;
		try {
			Map<String, Object> temp = JacksonUtil.JsonToBean(jsonStr, Map.class);
			if(temp != null) {
