package com.zhuqifeng.commons.utils.qrcode;
...
public class QRCodeUtil {
	 ...
	 */
	public static void generateQRImage(QRCodeZixingParams params) throws Exception {
	...
	private static void initData(QRCodeZixingParams params) {
	...
	public static void main(String[] args) throws Exception {
		QRCodeUtil.generateQRImage("http://zhu.hunme.net:9080/fintechBank-Act/active/active.html", "d:/logo2.png", "d:/qrcode", "a.png", "png");
	}

	public static class QRCodeZixingParams {
