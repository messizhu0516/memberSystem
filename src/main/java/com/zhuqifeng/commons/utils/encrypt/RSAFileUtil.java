 ...
 * File Name:RSAFileUtil.java  
 * Package Name:com.zhuqifeng.commons.utils.encrypt  
 * Date:2019年7月4日  下午4:08:32  
...
public class RSAFileUtil {
	...
	public static void main(String[] args) {
		RSAFileUtil rsa = new RSAFileUtil();
		String str = "我要加密这段文字。";
