...
public class FTPUtil {
	...
	public static void main(String[] args) throws Exception {
		...
		// ByteArrayInputStream("test ftp".getBytes("utf-8"));
		InputStream input = new FileInputStream("e:\\Users\\AOC\\Desktop\\pic\\06234945.jpg.238.jpg");

		// File inputFile = new File(projectPath + currPath);
		// String inPath = inputFile.getAbsolutePath();

		uploadFile("192.168.1.176", 21, "FTPTest", "123456", "/123", "aa.jpg", input);
	}
