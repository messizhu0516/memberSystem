...
<script type="text/javascript">
    ...
    function deleteRoleFun(id) {
        ...
        parent.$.messager.confirm('询问', '与该角色有关的所有数据将会被清除，您是否要删除当前角色？', function(b) {
            if (b) {
                progressLoad();
                $.post('${path }/role/delete', {
                    ...
                    console.log(result);
                    if (result.code == "000") {
                    	if (result.obj != null && result.obj != undefined && result.obj !="" && result.obj.hasRole == true) {
                    		parent.$.messager.confirm('提示', '删除成功，确定后将退出系统重新登录', function(b) {
                    			if (b) {
