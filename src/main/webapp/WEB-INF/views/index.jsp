...
<script type="text/javascript">
	...
	$(function() {
		...
		index_tabs = $('#index_tabs').tabs(
				{
					...
					tools : [
							{
								iconCls : 'fi-home icon-black',
								handler : function() {
									index_tabs.tabs('select', 0);
								}
							},
							{
								iconCls : 'fi-loop icon-black',
								handler : function() {
									refreshTab();
								}
							},
		...
		layout_west_tree = $('#layout_west_tree')
				.tree(
						{
							url : '${path }/resource/leftMenuTree',
							parentField : 'pid',
							lines : true,
...
<body>
	...
	<div id="mainLayout" class="easyui-layout" data-options="fit:true, border:false">
		<div data-options="region:'north',border:false, collapsedSize:0" style="height:50px;overflow: hidden; background-color:#C2C2C5">
			<div>
				<div style="float: left; padding: 20px;">
					<i class="fi-torso icon-black" style="margin-right:5px"></i><b><shiro:principal></shiro:principal></b>
				</div>
				<span style="float: right; padding-right: 20px; margin-top: 15px; color: #333">
					<shiro:hasPermission name="/user/editPwdPage">
						<a href="javascript:void(0)" onclick="editUserPwd()" class="easyui-linkbutton" plain="true" icon="fi-unlock icon-black">修改密码</a>
					</shiro:hasPermission>
					<a href="javascript:void(0)" onclick="logout()" class="easyui-linkbutton" plain="true" icon="fi-x icon-black">安全退出</a>
				</span>
				<span class="header"></span>
			</div>
		</div>
		<div data-options="region:'west',split:true" title="菜单" style="background-color: #b1bbbf; width: 160px; overflow: hidden; overflow-y: auto; padding: 0px">
		...
		<div data-options="region:'center'" style="overflow:hidden;">
			<div id="index_tabs" style="overflow: hidden;">
				<div title="首页" data-options="iconCls:'fi-home icon-black',border:false" style="overflow:hidden;"></div>
			</div>
		</div>
		<div data-options="region:'south',border:false" style="height: 30px; line-height:30px;overflow:hidden; text-align:center; background-color: #eee">
			Copyright © 2017 power by <a href="javascript:;" class="oceanus-a"></a>
		</div>
	</div>
	<div id="tabsMenu">
